...
extern W_Icon fighter_bitmap;
extern W_Icon base_fighterc_bitmap;
extern W_Icon fighterc_bitmap[NUM_CTORP_TYPES];
extern W_Icon base_fighter_explosion_bitmap;
extern W_Icon fighter_explosion_bitmap[BMP_FIGHTERDET_FRAMES];
extern W_Icon base_fighterc_explosion_bitmap;
extern W_Icon fighterc_explosion_bitmap[BMP_FIGHTERDET_FRAMES];
...
extern W_Icon base_wormhole_bitmap;
extern W_Icon wormhole_bitmap[WORMHOLE_VIEWS];
extern W_Icon wormhole_mbitmap;
...
extern int useCheckPlanets;	/* Send CP_PLANET packets to server checking planet status */
...
extern int useGeneric32;	/* Receive SP_GENERIC_32 packets */
