...
pushd %InstCWD%\netrek
%MyCWD%\tools\stampver -v%MyCWD%\src\stampver.inf -i4 -j4 netrek.exe
popd
goto :dist
...
mkdir %InstCWD%\bitmaps\weaplibm
copy resources\weaplibm\*.bmp %InstCWD%\netrek\bitmaps\weaplibm

mkdir %InstCWD%\bitmaps\planlibm
...
copy resources\misclib\mono\icon.bmp %InstCWD%\netrek\bitmaps\misclib
...
copy resources\ships\other\*.bmp %InstCWD%\netrek\bitmaps\shiplib
