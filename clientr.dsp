...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "win32" /I "win32\h" /I "include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "RSA" /FR /YX /FD /c
...
# ADD LINK32 libcmt.lib user32.lib gdi32.lib wsock32.lib kernel32.lib winmm.lib mpr.lib msvcrt.lib libgmp.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"\netrek_files\netrek\netrek.exe" /libpath:"win32/lib"
...
# ADD LINK32 libcmt.lib user32.lib gdi32.lib wsock32.lib kernel32.lib winmm.lib mpr.lib msvcrt.lib libgmp.lib /nologo /subsystem:console /profile /debug /machine:I386 /nodefaultlib /out:"\netrek_files\netrek\netrek.exe" /libpath:"win32/lib"
